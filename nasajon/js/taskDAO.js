...
function getTaskByFilterTable(objDataTable, objFilters, objModal, lstExclusion) {

	Pace.restart();
	//Pace.track(function () { })
	console.log("getTaskByFilterTable... start 🔵");
	$.ajax({
		type: "POST",
		...
		success: function (data) {
			...
			console.log("getTaskByFilterTable... finish 🔴");
			return
